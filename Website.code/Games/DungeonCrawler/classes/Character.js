...
class Character {
  ...
  takeDamage(damage, damageType = "physical") {
    ...
    // Apply dodge chance
    if (
      this.activeEffects.dodgeChance > 0 &&
      Math.random() < this.activeEffects.dodgeChance
    ) {
      return 0;
    }
  ...
  getEffectiveStrength() {
    ...
    if (
      ...
      this.equipment.weapon.statType === "strength"
    ) {
    ...
    if (
      ...
      this.equipment.accessory.statType === "strength"
    ) {
  ...
  getEffectiveAgility() {
    ...
    if (
      this.equipment.accessory &&
      this.equipment.accessory.statType === "agility"
    ) {
  ...
  getEffectivePower() {
    ...
    if (
      this.equipment.accessory &&
      this.equipment.accessory.statType === "power"
    ) {
  ...
  getEffectiveDefense() {
    ...
    if (
      this.equipment.accessory &&
      this.equipment.accessory.statType === "defense"
    ) {
  ...
  getPhysicalDefense() {
    return Math.floor(
      this.getEffectiveDefense() +
        this.getEffectiveAgility() * 0.15 +
        this.activeEffects.fortifyAmount,
    );
  }

  getMagicalDefense() {
    return Math.floor(
      this.getEffectiveAgility() * 0.2 + this.activeEffects.fortifyAmount,
    );
  }
