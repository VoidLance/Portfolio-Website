...
export default function Sidebar() {
  ...
  return (
    <aside className="static lg:sticky lg:top-20 glass-sidebar w-full lg:w-[18%] lg:min-w-[280px] p-4 text-base order-2 lg:order-1 rounded-xl lg:rounded-l-xl lg:rounded-r-none mb-5 lg:mb-0 lg:mr-5 h-auto lg:max-h-[calc(100vh-7rem)] flex flex-col overflow-hidden border-2 border-indie-accent-green">
