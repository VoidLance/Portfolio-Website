    ...
    constructor() {
        ...
        this.applyClassModifiers({
            ...
            startingEquipment: {
                ...
                armor: new EquipmentItem("Chainmail Shirt", 8, "common", "defense", { armorType: "heavy" }),
                accessory: null
            },
        ...
        this.passiveDescription = 'When your HP drops below 30%, gain +5 strength and +3 defense until the end of combat. This can only trigger once per battle.';
        ...
        this.classSpells = ['Shield', 'Fortify', 'Battle Cry', 'Cleave', 'Warlord\'s Might'];
...
class Mage extends Character {
    constructor() {
        ...
        this.passiveDescription = 'When you cast 3 spells in a row without using a basic attack, your next spell deals 50% bonus damage and costs 50% less mana.';
        ...
        this.classSpells = ['Magic Missile', 'Fireball', 'Mana Drain', 'Lightning Bolt', 'Ice Storm', 'Meteor', 'Arcane Blast', 'Time Stop'];
    ...
    constructor() {
        ...
        this.applyClassModifiers({
            ...
            startingEquipment: {
                ...
                armor: new EquipmentItem("Leather Vest", 2, "common", "agility", { armorType: "light" }),
        ...
        this.passiveDescription = 'When entering combat: If you have higher agility, gain a guaranteed critical hit. If enemy has higher agility, they attack first but you can dodge and gain +3 agility for that fight.';
        ...
        // Class-exclusive spells
        this.classSpells = ['Shadow Meld', 'Weaken', 'Poison Strike', 'Backstab', 'Shadow Step', 'Assassinate'];
...
class Paladin extends Character {
    constructor() {
        ...
        this.applyClassModifiers({
            ...
            startingEquipment: {
                weapon: new EquipmentItem("Iron Sword", 4, "common", "strength"),
                armor: new EquipmentItem("Chainmail Shirt", 8, "common", "defense", { armorType: "heavy" }), // Lowered starting armor
                accessory: new EquipmentItem("Guardian Amulet", 3, "uncommon", "defense")
            },
        ...
        this.passiveDescription = 'Once per battle, when you would take fatal damage, survive with 1 HP and heal for 15% of your max HP at the start of your next turn.'; // Nerfed healing
        ...
        // Class-exclusive spells
        this.classSpells = ['Heal', 'Shield', 'Holy Light', 'Cleanse', 'Divine Protection', 'Smite', 'Resurrection'];
...
const CLASS_DESCRIPTIONS = {
    Warrior: {
        ...
        strengths: ["High HP and defense", "Strong physical attacks", "Heavy armor proficiency", "Fortification buffs"],
        weaknesses: ["Low mana pool", "Limited magic abilities", "Less agile than other classes"],
        playstyle: "Tank and frontline fighter - absorb damage and deal heavy physical blows",
    ...
    Mage: {
        ...
        strengths: ["Massive spell damage", "Large mana pool", "Elemental mastery", "Range advantage"],
        weaknesses: ["Low HP", "Weak physical defense", "Vulnerable in melee", "Mana dependent"],
        playstyle: "Glass cannon - obliterate enemies with powerful spells before they reach you",
    ...
    Rogue: {
        ...
        strengths: ["Extremely high agility", "High dodge chance", "Critical strikes", "Fast attacks"],
        weaknesses: ["Lower HP than warriors", "Dependent on positioning", "Limited healing"],
        playstyle: "Hit-and-run tactics - dodge attacks and strike weak points for critical damage",
    ...
    Paladin: {
        ...
        strengths: ["Balanced stats", "Healing abilities", "Holy magic", "Good defense"],
        weaknesses: ["Jack of all trades, master of none", "No extreme specialization"],
        playstyle: "Versatile hybrid - adapt to any situation with a mix of combat, magic, and healing",
